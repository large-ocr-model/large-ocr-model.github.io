...
def create_info_from_file(filename, count=None):
    """
    ...
    strings, fonts, text_colors, orientations, distorsions, distorsion_orientations, skew_angles, random_skews, backgrounds, image_dirs= [], [], [], [], [], [], [], [], [], []
    list_info = list_info[:count] if count else list_info
    for info in list_info:
        try:
            string, font, text_color, orientation, distorsion, distorsion_orientation, skew_angle, random_skew, background, image_dir = info.split('\t')
        except:
            continue
        ...
        distorsions.append(int(distorsion))
        distorsion_orientations.append(int(distorsion_orientation))
        skew_angles.append(int(skew_angle))
        random_skews.append(bool(random_skew))

        backgrounds.append(int(background))
        image_dirs.append(image_dir)


    return strings, fonts, text_colors, orientations, distorsions, distorsion_orientations, skew_angles, random_skews, backgrounds, image_dirs
