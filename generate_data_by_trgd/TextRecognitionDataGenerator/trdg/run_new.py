...
def main():
    ...
    if args.use_wikipedia:
        ...
        strings, fonts, text_colors, orientations, distorsions, distorsion_orientations, skew_angles, random_skews, backgrounds, image_dirs = create_info_from_file(args.input_file, args.count)
        # orientations = [int(orientation) for orientation in orientations]
        # distorsions = [int(distorsion) for distorsion in distorsions]
        # distorsion_orientations = [int(distorsion_orientation) for distorsion_orientation in distorsion_orientations]
        # skew_angles = [int(skew_angle) for skew_angle in skew_angles]
        # random_skews = [bool(random_skew) for random_skew in random_skews]
        # backgrounds = [int(background) for background in backgrounds]
        # print(len(strings))
        # exit()
